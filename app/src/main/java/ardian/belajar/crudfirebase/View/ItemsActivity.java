...
import ardian.belajar.crudfirebase.Adapter.RecyclerAdapter;
...
public class ItemsActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    private void openDetailActivity(String[] data){
        ...
        intent.putExtra("NIM_KEY",data[1]);
        intent.putExtra("IMAGE_KEY",data[2]);
//        intent.putExtra("STUDI_KEY",data[3]);
    ...
    public void onItemClick(int position) {
        ...
        String[] teacherData={clickedTeacher.getName(),clickedTeacher.getNim(),clickedTeacher.getImageUrl(),clickedTeacher.getStudi()};
